...
func assertMatchingHostsOnCluster0(suite *ClusterSettingsApiTestCase, hosts []*HostConnection) {
	suite.Len(hosts, 2)
...
func assertMatchingHostsOnCluster1(suite *ClusterSettingsApiTestCase, hosts []*HostConnection) {
	suite.Len(hosts, 2)
